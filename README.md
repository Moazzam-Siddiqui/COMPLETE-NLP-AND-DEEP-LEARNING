...
1. [🧠 Natural Language Processing (NLP) — Text Preprocessing & Vectorization](#-natural-language-processing-nlp--text-preprocessing--vectorization)
2. [🧹 Cleaning the Input](#-cleaning-the-input)
3. [🔡 Converting Text to Vectors](#-converting-text-to-vectors)
4. [🤖 Deep Learning Techniques](#-deep-learning-techniques)
5. [💡 Use Cases of NLP](#-use-cases-of-nlp)
6. [✂️ Tokenization](#️-tokenization)
7. [📚 WordNet Lemmatizer](#-wordnet-lemmatizer)
8. [🧍‍♂️ Named Entity Recognition (NER)](#️-named-entity-recognition-ner)
9. [🔧 Basic Steps of Preprocessing](#-basic-steps-of-preprocessing)
10. [🔢 One-Hot Encoding (OHE)](#-one-hot-encoding-ohe)
11. [🧠 Bag of Words (BoW) Representation](#-bag-of-words-bow-representation)
12. [🔗 N-Grams](#-n-grams)
13. [🧮 TF–IDF (Term Frequency – Inverse Document Frequency)](#-tfidf-term-frequency--inverse-document-frequency)
14. [🧩 Word Embeddings](#-word-embeddings)
15. [🔄 SkipGram](#-skipgram)
16. [✅ Advantages of Word2Vec](#-advantages-of-word2vec)
17. [🤖 Deep Learning & Neural Networks](#-deep-learning--neural-networks)
18. [🔁 Sequential Data](#-sequential-data)
19. [⚙️ Why Prefer ANN over RNN?](#️-why-prefer-ann-over-rnn)
20. [🧠 Simple RNN (Recurrent Neural Network)](#-simple-rnn-recurrent-neural-network)
21. [🔙 RNN Back Propagation With Time](#-rnn-back-propagation-with-time)
22. [🧩 Simple ANN and RNN Projects](#-simple-ann-and-rnn-projects)
23. [🏗️ Building a Neural Network](#️-building-a-neural-network)
24. [🧠 Some Keywords within Neural Nets](#-some-keywords-within-neural-nets)
25. [⚙️ Optimizers](#️-optimizers)
26. [🧮 Loss Function](#-loss-function)
27. [🚫 Why ANN Isn’t Used Instead of RNN](#-why-ann-isnt-used-instead-of-rnn)
28. [🧠 LSTM (Long Short-Term Memory)](#-lstm-long-short-term-memory)
29. [💡 Conceptual Breakdown: RNN vs. LSTM](#-conceptual-breakdown-rnn-vs-lstm)
30. [🧱 LSTM Architecture Explained (Beginner + Technical)](#-lstm-architecture-explained-beginner--technical)
31. [🧩 Variants of LSTM RNN](#-variants-of-lstm-rnn)
32. [⚙️ Why use GRU instead of LSTM RNN?](#️-why-use-gru-instead-of-lstm-rnn)
33. [🧮 Mathematical Functioning (GRU)](#-mathematical-functioning-gru)
34. [🧠 Understanding What Each State Does (GRU)](#-understanding-what-each-state-does-gru)
35. [🕰️ Chronology Samjhiye (Understand the Chronology)](#-chronology-samjhiye-understand-the-chronology)
